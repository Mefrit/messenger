        ...
        function Scene(props) {
            ...
            _this.sentMessage = function (value) {
                ...
                fetch("/?module=dialog&action=Sent", {
                    ...
                    body: JSON.stringify({ id_sent: _this.state.id_sent, value: value, id_curent_user: _this.props.id_curent_user }),
                })
                    .then(function (data) { return data.json(); })
                    .then(function (result) {
        ...
        Scene.prototype.render = function () {
            ...
            return React.createElement("div", null,
                ...
                this.state.open_dialog ?
                    React.createElement(chat_1.ChatComponent, { history_message: this.state.history_message, sentMessage: this.sentMessage, id_curent_user: this.props.id_curent_user }) : "");
        };
        return Scene;
    }(React.Component));
    exports.Scene = Scene;
