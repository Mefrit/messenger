        ...
        ToolsComponent.prototype.renderFriendsList = function (list, show_message_count) {
            ...
            return list.map(function (element) {
                return (React.createElement("li", { key: element[0] + "list", onClick: function (e) {
                    ...
                    React.createElement("img", { className: "dialog__image-profile", src: "../src/images/profile.png", alt: "profile" }),
            ...
            return (React.createElement("div", { className: "container_tools" },
                React.createElement("div", { className: "menu" },
                    React.createElement("div", { className: "menu__logo" },
                        ...
                        React.createElement("img", { className: "menu__logo-image", src: "../src/images/logo.png", alt: "logo" })),
                    React.createElement("a", { href: "#message" },
                        React.createElement("img", { className: "menu__logo-image menu__logo-image_small", src: "../src/images/message.png", alt: "about" })),
                    React.createElement("a", { href: "#about" },
                        React.createElement("img", { className: "menu__logo-image", src: "../src/images/about.png", alt: "about" }))),
